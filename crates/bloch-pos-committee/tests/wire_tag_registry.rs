...
const TX_TAGS: &[(u8, Status)] = &[
    ...
    (
        0x07,
        Status::Contested(&[
            Claim { name: "DepositV2", refs: 13, example: "integ/exit-carrier-land" },
            Claim { name: "FundedDeposit", refs: 12, example: "dev1/transition-merge" },
            Claim { name: "DepositFunded", refs: 8, example: "dev4/writeoff-memo" },
            Claim { name: "SignedExit", refs: 2, example: "github/wip/funded-stake-a7" },
            Claim { name: "Withdraw", refs: 2, example: "worktree-agent-a1d31358b1c038bdf" },
        ]),
    ),
    (
        0x08,
        Status::Contested(&[
            Claim { name: "Withdraw", refs: 14, example: "integ/exit-carrier-land" },
            Claim { name: "SignedExit", refs: 12, example: "dev1/transition-merge" },
            Claim { name: "ExitV2", refs: 8, example: "dev4/writeoff-memo" },
        ]),
    ),
    (
        0x09,
        Status::Contested(&[
            Claim { name: "Withdraw", refs: 20, example: "dev1/transition-merge" },
            Claim { name: "ExitV2", refs: 7, example: "integ/exit-carrier-land" },
        ]),
    ),
];
