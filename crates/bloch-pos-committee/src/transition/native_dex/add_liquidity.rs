...
impl State {
    pub fn quote_blch_add_fee(&self, request: &Request) -> Result<fee_market::TxCharge, Error> {
        self.quote_blch_add_fee_with_context(request, self.base.next_base_fee(), 0)
    }
    pub(in crate::transition::native_dex) fn quote_blch_add_fee_with_context(
        &self,
        request: &Request,
        base_fee: u128,
        outer_bytes: u64,
    ...
    pub fn execute_blch_add(
        ...
        self.execute_blch_add_with_context(
            request,
            height,
    ...
    pub(in crate::transition::native_dex) fn execute_blch_add_with_context(
        &mut self,
        request: &Request,
        height: u64,
        base_fee: u128,
        ...
        let charge = self.quote_blch_add_fee_with_context(request, base_fee, outer_bytes)?;
