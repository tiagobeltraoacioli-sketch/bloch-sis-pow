...
//! ## Ownership
//!
//! The library is the composition root (PMO change-controlled; §9.4 two-reviewer
//! rule once integration review starts); the `bloch-pos` binary is a thin CLI
//! wrapper so decoder and protocol fuzzers exercise this exact implementation.
...
/// Run the `bloch-pos` command-line interface.
pub fn run_cli() {
