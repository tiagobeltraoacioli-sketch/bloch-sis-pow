...
This structural guard supports explicit mapping/list image fields, not arbitrary
YAML inheritance or generated configurations. Registry provenance and signatures
require separate release verification. It scans existing .yaml/.yml files under
deploy/, including nested files; it does not claim to scan only tracked files.
"""
