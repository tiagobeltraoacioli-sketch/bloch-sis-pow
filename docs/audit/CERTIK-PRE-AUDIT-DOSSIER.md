...
- The carryover set is 3,773,884,800 BLCH across **15 addresses** and 448,337
  UTXOs. The largest address holds 3,546,175,400 BLCH — **93.96% of the
...
*shares*. Independent parties hold 227,709,400 / 3,773,884,800 = **6.03%** of
...
2. **Genesis-3 terminal height: 50,000 decided, 80,000 everywhere.** The
   2026-08-12 decision lowers the halt to height 50,000 (~4 days out at
   decision time). Every committed artifact says 80,000 — `BLOCH-TOKENOMICS-V4.md`
   ...
   written for 80,000. Until code and fleet actually enforce 50,000, the
