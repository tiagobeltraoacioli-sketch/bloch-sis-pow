...
15 allocated: `DS_SORTITION`, `DS_ATTEST`, `DS_BLOCK`, `DS_BODY`, `DS_STATE`,
`DS_RANDAO`, `DS_DEPOSIT`, `DS_SPEND`, `DS_SPEND2`, `DS_TXID`, `DS_SLASH`,
...
All 15 values are pairwise distinct.
