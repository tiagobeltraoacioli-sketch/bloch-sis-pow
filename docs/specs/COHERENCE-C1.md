...
> **Corrected 2026-08-14: the chain is not a testnet.** This line read "Chain
> is still a zero-security testnet". Genesis-4 is a **live mainnet** carrying
> real balances. What remains true is the narrower claim the sentence was
> reaching for: **the shielded pool described here is not built, not wired and
> not audited, so Bloch offers no privacy today** — no privacy claim until
> audited (C4).
